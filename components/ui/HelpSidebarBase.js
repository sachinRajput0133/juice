...
export function HelpSidebarBase({ isOpen, onClose, content }) {
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Sidebar content */}
            <motion.div className='flex-grow overflow-y-auto px-6 py-4' variants={contentVariants}>
            ...
            >
              <p className='text-sm text-gray-500 dark:text-gray-400'>
                ...
                <a href='mailto:support@juicefin.com' className='text-blue-600 hover:underline'>
